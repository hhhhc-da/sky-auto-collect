...
使用 ResNet18 作为分类网络, 训练的看起来不是很成功(?经验告诉我这有点过拟合但是也许不是), 经过测试也是效果拉的一比

![image](./images/train.png)

还是走传统路线了, 开始抓取图片中心的旋转不变特性, 还能顺便清理一下文字的那些杂色
...
(可以看到里面完全是一个四角星检测，检测到四角星就判定为需要赠送心火，而八角星判定为不需要送心火)

2. 使用目标检测算法确定物体位置并控制任务游走
